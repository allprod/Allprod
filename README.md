...
- [markdown-confluence/docs-markdown-confluence](https://github.com/markdown-confluence/docs-markdown-confluence) - Docs for Markdown Confluence Tools (1 month ago)
...
- [djensenius/battery_hearts](https://github.com/djensenius/battery_hearts) - A terminal battery indicator using hearts - supports both nerdfont symbols and emoji (8 months ago)
- [platformatic/intelligent-command-center](https://github.com/platformatic/intelligent-command-center) - Platformatic Intelligent Command Center (9 months ago)
