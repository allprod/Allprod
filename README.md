...
- [markdown-confluence/docs-markdown-confluence](https://github.com/markdown-confluence/docs-markdown-confluence) - Docs for Markdown Confluence Tools (3 months ago)
- [chromaui/learnstorybook.com](https://github.com/chromaui/learnstorybook.com) - Static site and content for Storybook tutorials (10 months ago)


#### 🏗️ Stuff i've done  
- Applications Office at [Smart Zambia Institute](https://www.szi.gov.zm) [Stationed at [Ministry of Mines and Minerals Development](https://www.mmmd.gov.zm)]:
...
- [Introduction to Entropy](https://allprod.github.io/posts/hithere/) (4 years ago)


#### ⭐ Recent Stars

- [djensenius/battery_hearts](https://github.com/djensenius/battery_hearts) - A terminal battery indicator using hearts - supports both nerdfont symbols and emoji (10 months ago)
- [platformatic/intelligent-command-center](https://github.com/platformatic/intelligent-command-center) - Platformatic Intelligent Command Center (11 months ago)
- [hedge-dev/XenonRecomp](https://github.com/hedge-dev/XenonRecomp) - A tool for recompiling Xbox 360 games to native executables. (2 years ago)
- [carbon-language/carbon-lang](https://github.com/carbon-language/carbon-lang) - Carbon Language&#39;s main repository: documents, design, implementation, and related tools. (NOTE: Carbon Language is experimental; see README) (4 years ago)
- [golang/go](https://github.com/golang/go) - The Go programming language (4 years ago)
- [jswanner/DontF-WithPaste](https://github.com/jswanner/DontF-WithPaste) - Google Chrome extension that prevents the blocking of pasting into input fields (5 years ago)
...
- [gelstudios/gitfiti](https://github.com/gelstudios/gitfiti) - abusing github commit history for the lulz (6 years ago)
